...
## References
[1] Hartloper, de Castro e Sousa, and Lignos (n.d.). "Warping-Inclusive Kinematic Coupling in Mixed-Dimension Macro Models for Wide-flange Beam-Columns", Journal of Structural Engineering (submitted).
