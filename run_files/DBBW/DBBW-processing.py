...
inp_file = 'run_files/DBBW/DBBW-FlexTop-NoParts.inp'
cdef_file = 'run_files/DBBW/DBBW-FlexTop-NoParts-CDef.txt'
out_dir = 'run_files/DBBW/output/'
imp_file = os.path.join(out_dir, 'DBBW-FlexTop-NoParts-Imp.txt')
